...
A console duel simulator: fighters of different classes, items, turn-based battles with logs,
critical hit chance, a tournament, and a final fight between winners.

## My role

- Built the project as part of Yandex Practicum hackathon practice and performed **manual testing** of logic and edge cases.
