# The Snake (Python/Pygame) — Case study
...
Additional mechanics: wrap-around (leaving the field → appearing on the opposite side) and a Game Over sound.

## My role

- Built the project as part of Yandex Practicum coursework and performed **manual testing** of mechanics and state transitions.
